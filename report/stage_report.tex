...
\centering
\vspace{3cm}
{\bfseries\LARGE INRIA \par} %CNRS Alsace delegation - 
\vspace{4cm}
...
%For different number of epochs the error of the NN in L2 norm is shown in the following table:
%for different nimber of points depending on the case and all shown in the table 
...
% \begin{thebibliography}{9} % Use a number larger than the total number of references (e.g., 9 in this case)
...
%     \bibitem{6} Towards Data Science. (n.d.). Multilayer Perceptron Explained with a Real-Life Example and Python Code: Sentiment Analysis. Retrieved from \url{https://towardsdatascience.com/multilayer-perceptron-explained-with-a-real-life-example-and-python-code-sentiment-analysis-cb408ee93141}
