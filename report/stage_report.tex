...
% \begin{figure}[h]  % "h" stands for "here", indicating that you want the figure to be placed as close as possible to the current position in the text
%     \centering
%     \includegraphics[width=\textwidth]{image.jpg}  % Replace "image.jpg" with the filename of your image
