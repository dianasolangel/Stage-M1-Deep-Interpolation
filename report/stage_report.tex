...
I will provide a theoretical framework for understanding augmented interpolation and PINNs, in the implementation section, I will describe the code developed for the PINNs approach, including the optimization process. I will also provide code snippets and explanations of the most important parts of the code.
...
It may seem strange to define the partial derivative of a neural network, but since the neural network's activation function is smooth and differentiable, and we can derive it using automatic differentiation for any values of $x$ and $t$.

%No se si esta bien 
We look to minize $\theta$ in order to minimize the error of our neural network.
